...
def test_search_enr_3_x():
    ...
    webscrapi = Webscrape()
    file_names = [
        ("ENR-3.2_151.csv", "ENR-3.2-Q63.txt"),
        ("ENR-3.2_67.csv", "ENR-3.2-N16.txt"),
        ("ENR-3.2_88.csv", "ENR-3.2-N90.txt"),
        ("ENR-3.2_22.csv", "ENR-3.2-L603.txt"),
        ("ENR-3.2_5.csv", "ENR-3.2-L15.txt"),
        ]
